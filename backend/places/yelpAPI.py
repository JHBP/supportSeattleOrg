...
#TODO: keys needs to be stored in different ways
...
DEFAULT_TERM = 'dinner gym'
DEFAULT_RADIUS = 1000
DEFAULT_LOCATION = '98119'
SEARCH_LIMIT = 50
...
def query_api(term = '', location = 'Seattle', offset = 0):
    ...
    print(u'{0} buisnesses found'.format(len(businesses)))
